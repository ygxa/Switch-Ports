if (room != scootercutsceneidk && room != devroom && room != palroom && room != rank_room && room != timesuproom && room != realtitlescreen && room != rm_credits)
{
    ...
    {
        draw_sprite_ext(spr_tvstatic, statindex, 832, 74 + DrawY + bobbing, 1, 1, 0, c_white, 1);
    ...
    if (tvsprite != 926 && tvsprite != 621 && global.dialogueVolume <= 0)
    ...
    draw_sprite_ext(spr_tvcomboshadow, image_index, 832, 74 + DrawY + bobbing, 1, 1, 0, c_white, combofade);
    ...
    else if (chooseOnecomboend == true)
    {
