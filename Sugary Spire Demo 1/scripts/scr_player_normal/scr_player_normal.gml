function scr_player_normal()
{
    ...
    if (character == "P" && (key_slap2 && !key_down && suplexmove == 0 && shotgunAnim == 0 && global.cane != 1) && obj_player.character != "G" && !key_attack)
    {
        scr_sound(69);
    ...
    if (character == "N" && (key_slap2 && !key_down && suplexmove == 0 && shotgunAnim == 0 && global.cane != 1) && obj_player.character != "G" && obj_player.sprite_index != spr_mach1 && sprite_index != spr_airdash1 && sprite_index != spr_airdash2 && !key_attack)
    {
        scr_sound(69);
        instance_create(x, y, obj_slaphitbox);
        suplexmove = 1;
