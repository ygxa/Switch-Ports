function scr_confecti_normal()
{
    ...
    var _leader = -4;
    _leader = !ds_list_find_index(global.FollowerList, id) ? 147 : ds_list_find_value(global.FollowerList, floor(ds_list_find_index(global.FollowerList, id) - 1));
    ...
    if (obj_player.state == 43 && obj_player.sprite_index == spr_pizzelle_taunt && state != 1)
    {
