function scr_solid_player(argument0, argument1, argument2 = false)
{
    ...
    if (place_meeting(x, y, obj_platform))
    {
        ...
        if (y > old_y)
        {
            ...
            var _platforms = instance_place_list(x, y, 261, _list, false);
            var collided = false;
            ...
            if (_platforms > 0)
            {
                for (var i = 0; i < _platforms; i++)
                {
                    ...
                    if (_can_collide == true && place_meeting(x, y, platform) && !place_meeting(x, old_y, platform))
                        collided = true;
                }
            }
