function scr_slopeangle(argument0 = x, argument1 = y, argument2 = 3)
{
    var array = 0;
    var checkside = -1;
    ...
    while (i < 2)
    {
        ...
        {
            array[i] = y;
            var check_1 = scr_solid_player(x + (argument2 * checkside), y + top);
            var check_2 = !scr_solid_player(x + (argument2 * checkside), (y + top) - 1);
...
function scr_slopeanglenonplayer(argument0, argument1, argument2 = 1)
{
    ...
    while (i < 2)
    {
        ...
        {
            array[i] = argument1;
            var check_1 = scr_solid(argument0 + (argument2 * checkside), argument1 + top);
            var check_2 = !scr_solid(argument0 + (argument2 * checkside), (argument1 + top) - 1);
