var Collisions = [obj_solid, obj_slope, obj_platform, obj_slopePlatform, obj_movingPlatform, obj_movingPlatformTrigger, obj_secretdestructible, obj_doorA, obj_doorB, obj_doorC, obj_doorD, obj_doorS];
