...
__draw_text_transformed_colour_hook(get_game_width() / 2, (get_game_height() / 2) + 45, string_get("menu/timetrialpopup/desc"), descanim, descanim, descspin, c_white, c_white, c_white, c_white, (descstate == 2) ? descalpha : 1);
