...
if state == baddiestate.float {
	...
	if state == baddiestate.float && alarmed movespeed = 4
	if alarm[3] > 0 hsp = 0
}
...
/*	
if triangle_meeting(obj_player.x, obj_player.y, x, y, _x, y + 85, _x, y - 85) && !alarmed && state == baddiestate.float && obj_player.state != states.comingoutdoor && obj_player.state != states.door && grounded {
