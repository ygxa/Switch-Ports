if (global.P2Cpu == false)
{
    ...
    {
        if (gamepad_axis_value(global.P2controllerport, gp_axisrh) < 0)
            _axis_pressed_left2 = true;
    }
    
    axis_left_prev2 = gamepad_axis_value(global.P2controllerport, gp_axisrh) < 0;
    ...
    axis_right_prev2 = gamepad_axis_value(global.P2controllerport, gp_axisrh) > 0;
    b_right_press2 = _axis_pressed_right2;
    
    if (_axis_pressed_down2 == false && axis_down_prev2 == false)
    {
        if (gamepad_axis_value(global.P2controllerport, gp_axisrv) > 0)
            _axis_pressed_down2 = true;
    }
    
    axis_down_prev2 = gamepad_axis_value(global.P2controllerport, gp_axisrv) > 0;
    ...
    axis_up_prev2 = gamepad_axis_value(global.P2controllerport, gp_axisrv) < 0;
