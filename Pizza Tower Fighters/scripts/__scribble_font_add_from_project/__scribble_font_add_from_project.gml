function __scribble_font_add_from_project(argument0)
{
    ...
    try
    {
        var _is_krutidev = __scribble_asset_is_krutidev(argument0, 6);
        ...
        repeat (_size)
        {
            ...
            ds_grid_set(_font_glyph_data_grid, _i, (3 << 0), _glyph_dict.offset);
            ...
            ds_grid_set(_font_glyph_data_grid, _i, (7 << 0), _h);
