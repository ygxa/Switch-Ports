function __scribble_gen_2_parser()
{
    ...
    if (ds_grid_width(_glyph_grid) < _element_expected_text_length)
        ds_grid_resize(_glyph_grid, _element_expected_text_length, (23 << 0));
    
    if (ds_grid_width(_word_grid) < _element_expected_text_length)
        ds_grid_resize(_word_grid, _element_expected_text_length, (23 << 0));
    
    if (ds_grid_width(_vbuff_pos_grid) < _element_expected_text_length)
        ds_grid_resize(_vbuff_pos_grid, _element_expected_text_length, (23 << 0));
    ...
    var _font_space_width = ds_grid_get(_font_glyph_data_grid, _space_data_index, (5 << 0));
    ...
    while (true)
    {
            ...
            if (_glyph_ord == 93)
            {
                ...
                switch (ds_map_find_value(_command_tag_lookup_accelerator_map, _tag_command_name))
                {
                    case 0:
                        ...
                        if (_font_name != _starting_font)
                        {
                            ...
                            _font_space_width = ds_grid_get(_font_glyph_data_grid, _space_data_index, (5 << 0));
                    ...
                    case 6:
                        ...
                        ds_grid_set(_glyph_grid, _glyph_count, (18 << 0), _control_count);
                        _glyph_count++;
                    ...
                    case 28:
                        ...
                        ds_grid_set(_glyph_grid, _glyph_count, (17 << 0), undefined);
                        ds_grid_set(_glyph_grid, _glyph_count, (18 << 0), _control_count);
                        _glyph_count++;
                        _glyph_prev_arabic_join_next = false;
                        _glyph_prev_prev = _glyph_prev;
                    ...
                    default:
                        ...
                        else if (asset_get_type(_tag_command_name) == 1)
                        {
                            ...
                            ds_grid_set(_glyph_grid, _glyph_count, (17 << 0), undefined);
                            ds_grid_set(_glyph_grid, _glyph_count, (18 << 0), _control_count);
                            ds_grid_set(_glyph_grid, _glyph_count, (20 << 0), _sprite_index);
                            ds_grid_set(_glyph_grid, _glyph_count, (21 << 0), _image_index);
                            ds_grid_set(_glyph_grid, _glyph_count, (22 << 0), _image_speed);
                            _glyph_count++;
                            _glyph_prev_arabic_join_next = false;
                            _glyph_prev_prev = _glyph_prev;
                            _glyph_prev = -1;
                ...
                if (_new_halign != undefined && _new_halign != _state_halign)
                {
                    ...
                    if (_glyph_count > 0)
                    {
                        ...
                        {
                            ds_grid_set_post(_glyph_grid, _glyph_count - 1, (18 << 0), ds_grid_get(_glyph_grid, _glyph_count - 1, (18 << 0)) + 1);
                        }
                    }
                }
        ...
        else if (_glyph_ord > 32)
        {
            ...
            if (_glyph_write >= 1536 && _glyph_write <= 1791)
            {
                ...
                if (_data_index == undefined)
                {
                    __scribble_trace("Couldn't find \"missing character\" glyph data, character code 63 (?) in font \"" + string(_font_name) + "\"");
                }
                else
                {
                    ds_grid_set_grid_region(_glyph_grid, _font_glyph_data_grid, _data_index, (1 << 0), _data_index, (18 << 0), _glyph_count, (0 << 0));
                    ds_grid_set(_glyph_grid, _glyph_count, (18 << 0), _control_count);
