function player_test_side_aerial()
{
    ...
    if (sprite_index != s_test_side_aerial)
    {
        image_speed = 1;
        sprite_index = s_test_side_aerial;
        image_index = 0;
        ds_list_clear(HitByAttack);
    }
    
    mask_index = s_test_side_aerial_col;
    ...
    if (floor(image_index) == (image_number - 1) || place_meeting(x, y + 1, ObjWall) || place_meeting(x, y + 1, ObjWall))
    {
        mask_index = s_test_idl;
        state = (0 << 0);
    }
