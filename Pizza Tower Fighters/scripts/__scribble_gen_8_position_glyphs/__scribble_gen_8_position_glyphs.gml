function __scribble_gen_8_position_glyphs()
{
    ...
    ds_grid_multiply_region(_glyph_grid, 0, (19 << 0), _glyph_count - 1, (19 << 0), 1000);
    ...
    repeat (__pages)
    {
        ...
        repeat ((1 + _page_end_line) - _page_start_line)
        {
            ...
            ds_grid_add_region(_glyph_grid, _line_glyph_start, (19 << 0), _line_glyph_end, (19 << 0), _j - _page_start_line);
