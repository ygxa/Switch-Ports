function __scribble_gen_6_build_lines()
{
    ...
    repeat (7)
    {
        ...
        if (_word_count > 0)
        {
            ...
            var _line_y = 0;
            var _indent_x = 0;
            var _control_delta = ds_grid_get(_glyph_grid, 0, (18 << 0)) - _control_index;
            ...
            repeat (_word_count)
            {
                ...
                _control_delta = ds_grid_get(_glyph_grid, _word_start_glyph, (18 << 0)) - _control_index;
                ...
                else
                {
                    ...
                    else if (_glyph_start_ord == 0)
                    {
                        ...
                        if (_i < (_word_count - 1))
                            ds_grid_set(_line_grid, _line_count, (7 << 0), true);
                    }
                }
