function player_doise_down_aerial_start()
{
    key_down = 1;
    
    if (sprite_index != s_doise_down_aerial_start)
    {
        hurt = true;
        grv = 0.5;
        vsp = -10;
        audio_play_sound(su_doise_downaerial, 50, false);
        sprite_index = s_doise_down_aerial_start;
        image_index = 0;
        image_speed = 1;
    }
