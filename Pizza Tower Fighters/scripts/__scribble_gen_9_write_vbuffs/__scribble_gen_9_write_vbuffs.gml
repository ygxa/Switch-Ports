function __scribble_gen_9_write_vbuffs()
{
    ...
    repeat (__pages)
    {
        ...
        {
            _packed_indexes = ds_grid_get(_glyph_grid, _i, (19 << 0));
            _control_delta = ds_grid_get(_glyph_grid, _i, (18 << 0)) - _control_index;
                    ...
                    case (5 << 0):
                        if (_region_name != undefined)
                        {
                            ...
                            if (_region_start <= _region_end)
                            {
                                ...
                                {
                                    __x1: ds_grid_get_min(_vbuff_pos_grid, _region_bbox_start, (0 << 0), _region_end, (0 << 0)),
                                    __y1: ds_grid_get_min(_vbuff_pos_grid, _region_bbox_start, (1 << 0), _region_end, (1 << 0)),
                                    __x2: ds_grid_get_max(_vbuff_pos_grid, _region_bbox_start, (2 << 0), _region_end, (2 << 0)),
                                    __y2: ds_grid_get_max(_vbuff_pos_grid, _region_bbox_start, (3 << 0), _region_end, (3 << 0))
                                });
            ...
            if (_glyph_ord == -1)
            {
                ...
                _packed_indexes = ds_grid_get(_glyph_grid, _i, (19 << 0));
                var _sprite_index = ds_grid_get(_glyph_grid, _i, (20 << 0));
                var _image_index = ds_grid_get(_glyph_grid, _i, (21 << 0));
                var _image_speed = ds_grid_get(_glyph_grid, _i, (22 << 0));
                ...
                repeat ((_image_speed > 0) ? _sprite_number : 1)
                {
                    ...
                    if (_glyph_texture != _last_glyph_texture)
                    {
                        ...
                        _vbuff = _page_data.__get_vertex_buffer(_glyph_texture, ds_grid_get(_glyph_grid, _i, (15 << 0)), ds_grid_get(_glyph_grid, _i, (16 << 0)), ds_grid_get(_glyph_grid, _i, (17 << 0)), self);
                    }
            ...
            else if (_glyph_ord == -2)
            {
                ...
                _glyph_scale = ds_grid_get(_glyph_grid, _i, (9 << 0));
    ...
    var _control_delta = ds_grid_get(_glyph_grid, _i - 1, (18 << 0)) - _control_index;
