function player_faker_down_aerial()
{
    if (sprite_index != s_fakepep_down_aerial)
    {
        grv = 0.75;
        audio_play_sound(su_fakepep_bodyslam, 50, false);
        sprite_index = s_fakepep_down_aerial;
        image_index = 0;
        image_speed = 1;
    ...
    y += vsp;
    mask_index = s_fakepep_down_aerial_col;
    ...
    if (Hits > 0)
    {
        for (var i = 0; i < Hits; i++)
        {
            ...
            if (ds_list_find_index(HitByAttack, HitID) == -1)
            {
                ...
                with (HitID)
                    player_hurt(15, -5, other.facing, 4);
            }
        }
    }
