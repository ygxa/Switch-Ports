if (room == Realtitlescreen || room == rank_room || instance_exists(obj_titlecard))
    exit;
...
draw_text(obj_screen.actualWidth - ((string_length(finalstr) - 1) * string_width("A")), obj_screen.actualHeight - 8, finalstr);
