function scr_player_crouchslide()
{
    ...
    if (mach2 >= 35 && (!key_down && (!scr_solid(x + 27, y - 32) && (!scr_solid(x - 27, y - 32) && (!scr_solid(x, y - 32) && (!scr_solid(x, y - 16) && (key_attack && sprite_index != get_charactersprite("spr_shootslide"))))))))
    {
        if (character == "P")
            sprite_index = get_charactersprite("spr_machhit");
