function scr_player_gameover()
{
    ...
    if (sprite_index == get_charactersprite("spr_deathstart"))
    {
        vsp = 0;
        hsp = 0;
    }
    ...
    if (floor(image_index) == (image_number - 1) && sprite_index == get_charactersprite("spr_deathstart"))
    {
        alarm[10] = 5;
        vsp = -10;
        sprite_index = get_charactersprite("spr_deathend");
    }
