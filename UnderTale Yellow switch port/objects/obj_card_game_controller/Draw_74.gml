...
draw_text(32, 16, string_hash_to_newline(___string(clamp(instance_number(obj_card_game_card) - 20, 0, 999))));
...
draw_text(290, 16, string_hash_to_newline(___string((cardg_timer / 30) div 60) + ":" + ___string(floor(cardg_timer / 30) % 60)));
...
if (cardg_victory == true)
{
    ...
    draw_set_halign(fa_center);
    draw_text(160, 120, string_hash_to_newline(___string(floor(cardg_g_gained)) + "G won!"));
}
