if (control_test == false)
{
    ...
    draw_text(xx, __view_get(e__VW.YView, 0) + 130, string_hash_to_newline("DEADZONE :: " + ___string(round(global.gamepad_deadzone * 100)) + "%"));
    draw_set_color(c_white);
    ...
    draw_text(xx + 180, __view_get(e__VW.YView, 0) + 79, string_hash_to_newline(___string(global.buttonText1)) + ", RB");
    draw_text(xx + 180, __view_get(e__VW.YView, 0) + 94, string_hash_to_newline(___string(global.buttonText2)) + ", LB");
    draw_text(xx + 180, __view_get(e__VW.YView, 0) + 109, string_hash_to_newline(___string(global.buttonText3)));
}
