...
draw_text(xx - 28, yy - 2.5, string_hash_to_newline("LV " + ___string(global.player_level)));
draw_text(xx - 28, yy + 5, string_hash_to_newline("HP " + ___string(global.current_hp_self) + "/" + ___string(global.max_hp_self)));
draw_text(xx - 28, yy + 12.5, string_hash_to_newline("G   " + ___string(global.player_gold)));
draw_set_font(fnt_battle);
draw_text(xx - 28, yy - 22, string_hash_to_newline(___string(global.player_name)));
...
if (stats_open == true)
{
    ...
    draw_text(xx + 150, yy - 10, string_hash_to_newline("LV " + ___string(global.player_level)));
    draw_text(xx + 57.2, yy + 10, string_hash_to_newline("HP " + ___string(global.current_hp_self) + " / " + ___string(global.max_hp_self)));
    draw_text(xx + 57.2, yy + 35, string_hash_to_newline("AT " + ___string(global.player_attack) + "(" + ___string(global.player_weapon_modifier_attack) + ")"));
    draw_text(xx + 57.2, yy + 50, string_hash_to_newline("DF " + ___string(global.player_defense) + "(" + ___string(global.player_armor_modifier_defense + global.player_armor_defense) + ")"));
    draw_text(xx + 130, yy + 35, string_hash_to_newline("EXP " + ___string(global.player_exp)));
    var level_up_treshhold = global.player_exp_next[global.player_level] - global.player_exp;
    draw_text(xx + 130, yy + 50, string_hash_to_newline("NEXT " + ___string(level_up_treshhold)));
    ...
    draw_text(xx + 57.2, yy + 140, string_hash_to_newline("GOLD: " + ___string(global.player_gold)));
}
