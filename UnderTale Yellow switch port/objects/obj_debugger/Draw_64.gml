...
draw_text(xx + 180, yy, string_hash_to_newline("###FPS: " + ___string(fps)));
draw_text(xx + 180, yy, string_hash_to_newline("####ROOM: " + ___string(room_get_name(room))));
draw_set_color(c_white);
...
if (dbg_menu == 3)
{
    for (var i = 0; i < ds_map_size(cheat_map); i++)
    {
        ...
        {
            case 0:
                draw_text(xx, yy, string_hash_to_newline("GAME SPEED: " + ___string(current_value)));
                break;
            
            case 1:
                draw_text(xx, yy * 2, string_hash_to_newline("9999 HP: " + ___string(current_value)));
                break;
            
            case 2:
                draw_text(xx, yy * 3, string_hash_to_newline("NO COL: " + ___string(current_value)));
                break;
            
            case 3:
                draw_text(xx, yy * 4, string_hash_to_newline("GET G: " + ___string(current_value)));
                break;
