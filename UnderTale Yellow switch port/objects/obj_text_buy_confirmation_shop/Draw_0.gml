...
draw_text(obj_main_screen_shop.x + 230, obj_main_screen_shop.y + 10, string_hash_to_newline("Buy it for#" + ___string(global.shop_gold_requirement[buy_shop_screen_number]) + "G ?"));
