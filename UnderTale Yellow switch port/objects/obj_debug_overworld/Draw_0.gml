...
{
    draw_text(__view_get(e__VW.XView, 0) + dd_x, __view_get(e__VW.YView, 0) + dd_y, string_hash_to_newline("FPS: " + ___string(fps) + "#FPS REAL:" + ___string(fps_real)));
    ...
    else if (seldepth_main == 1)
    {
        ...
        else if (selnum_main == 5)
        {
            ...
            for (i = 0; i <= option_count; i++)
            {
                ...
                draw_text(__view_get(e__VW.XView, 0) + dd_x, __view_get(e__VW.YView, 0) + dd_y, string_hash_to_newline(indent + option[i] + ___string(selnuml_stat[i])));
            }
        }
    }
}
