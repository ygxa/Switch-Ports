function scr_mail_check()
{
    ...
    switch (mail)
    {
        ...
        case "Shufflers Letter":
            info = "#To our latest Shufflers recruit:#Toast here. There's someone out#in the wild that we forgot to#warn ya about. This scruffy#fella with a blue hat. Don't#interact with him or support#his endeavors. I won't tell ya#why cause this letter reads way#cooler as a mystery.#" + ___string("#Now, I'll let {0} finish this.", global.fun_swig_name) + "#He gets upset when he misses#" + "out on writing letters." + "#" + "#" + "#" + "#" + "#Yeah, upset." + "#" + ___string("#-{0} ", global.fun_swig_name);
