function scr_item_use_text_yellow()
{
    ...
    {
        message[0] = "* (You drink the " + ___string(item_slot) + ".)";
    ...
    {
        message[0] = "* (You scarf down the " + ___string(item_slot) + ".)";
    ...
    {
        message[0] = "* (You equipped the " + ___string(item_slot) + ".)";
    ...
    {
        message[0] = "* (You stick the " + ___string(item_slot) + " into#  your hat.)";
    ...
    {
        message[0] = "* (You pin the " + ___string(item_slot) + "#  to your hat.)";
        item_use_hold.item_category = "equip";
        item_use_hold.item_type = "accessory";
        item_use_hold.item_sound = 388;
    }
    ...
    if (execute_hp == true)
    {
        ...
        if ((current_hp_self + item_use_hold.item_number) < max_hp_self)
            message[cmsgn] = message_add + "* (You recovered " + ___string(item_use_hold.item_number) + " HP!)";
        else
    ...
    if (execute_pp == true)
    {
        ...
        if ((current_pp_self + item_use_hold.item_number) < max_pp_self)
            message[cmsgn] = message_add + "* (You gained " + ___string(item_use_hold.item_number) + " PP!)";
        else
    ...
    if (execute_sp == true)
    {
        ...
        if ((current_sp_self + item_use_hold.item_number) < max_sp_self)
            message[cmsgn] = message_add + "* (You gained " + ___string(item_use_hold.item_number) + " SP!)";
        else
    ...
    if (execute_rp == true)
    {
        ...
        if ((current_rp_self + item_use_hold.item_number) < max_rp_self)
            message[cmsgn] = message_add + "* You will heal for " + ___string(item_use_hold.item_number) + " turns!";
        else
