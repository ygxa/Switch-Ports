...
else if (tab != -1)
{
    ...
    if (tab != -1 && (keyboard_check_pressed(vk_enter) || (global.ostype == 1 && !keyboard_virtual_status())))
    {
...
if ((keyboard_check_pressed(vk_enter) || (global.ostype == 1 && !keyboard_virtual_status())) && detected != -1)
{
    if (global.ostype == 1)
        keyboard_virtual_hide();
