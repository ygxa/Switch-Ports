...
if (!trapped)
{
    if (obj_player1.sprite_index == spr_lonegustavo_hurt || obj_player1.state == 261 || obj_player1.state == 199 || obj_player1.state == 204 || obj_player1.state == 263 || obj_player1.state == 262)
    {
        wait = 1;
