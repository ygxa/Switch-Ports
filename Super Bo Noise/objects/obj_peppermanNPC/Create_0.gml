...
dialog[2] = dialog_create("Meet me at the Mr. Stick arena just east of here, and we can settle this.", -4, function() //anon@352@gml_Object_obj_peppermanNPC_Create_0
{
