...
safe_layer_set_depth = function(argument0, argument1) //anon@6626@gml_Object_obj_parallax_Create_0
{
    if (layer_exists(argument0) && number_in_range(argument1, -16000, 16000))
        layer_depth(argument0, argument1)
}

set_layer_depths = function() //anon@6836@gml_Object_obj_parallax_Create_0
{
    ...
    for (var i = 0; i < array_length(a); i++)
    {
        ...
        if (!(is_undefined(ds_map_find_value(temp_map, layer_check_name))))
        {
            ...
            self.safe_layer_set_depth(a[i], ((ds_map_find_value(temp_map, layer_check_name)) - sub))
        }
    }
