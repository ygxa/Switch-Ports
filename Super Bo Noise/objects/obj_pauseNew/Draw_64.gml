...
if (pauseScale < 5 && realPauseAlpha > 0)
{
    ...
    {
        bg_surf = surface_create(global.resolutions[0][1][0], global.resolutions[0][1][1]);
    }
    else
    {
        ...
        pad = 48;
        draw_text_scribble(480, 500, string("[fa_center][shake][spr_transfopromptfont]" + string(global.TransfoPrompt)));
