...
if (state == 136)
{
    ...
    else if (t && collision_line(x, y, playerid.x, playerid.y, obj_solid, false, true) == -4)
    {
        ...
        {
            if ((id == b || distance_to_object(other) < 300) && state != 6 && state != 140 && state != 139 && state != 268)
            {
                state = 94;
...
else if (state == 82)
{
    ...
    else if (instance_exists(leaderID) && leaderID.state == 82)
    {
...
if (state != 82 && hitboxID != -4 && instance_exists(hitboxID))
{
