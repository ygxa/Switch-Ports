...
var scare_check = targetplayer.state == 43 || targetplayer.state == 123 || targetplayer.state == 33 || targetplayer.state == 186 || targetplayer.state == 22 || targetplayer.state == 40 || (targetplayer.state == 81 && targetplayer.swingdingdash <= 0 && targetplayer.sprite_index == targetplayer.spr_swingding);
