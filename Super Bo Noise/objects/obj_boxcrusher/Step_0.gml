if (y == ystart && obj_player1.boxxed == 0 && obj_player1.state != (35 << 0) && obj_player1.state != (36 << 0) && obj_player1.state != (37 << 0) && obj_player1.x > (x - 50) && obj_player1.x < (x + 50) && obj_player1.y > y && obj_player1.y < (y + 200))
{
    vsp = 10
