...
if (obj_player1.finisher || obj_player2.finisher || (obj_player1.state == 254 && obj_player1.superattackstate == 10))
...
with (obj_baddie)
{
    ...
    if (visible && object_index != obj_pizzaball && bbox_in_camera_ext(view_camera[0], 100))
    {
        ...
        {
            if (state == 208 && instance_exists(playerid))
            {
                var x1 = x + 3;
                var y1 = y + 30;
