            ...
            with (trapid)
            {
                switch object_index
                {
                    case obj_anchortrap:
                        ...
                        if (state != (137 << 0) && state != (94 << 0) && obj_player1.x > (x - 100) && obj_player1.x < (x + 100) && obj_player1.y > y && obj_player1.y < (y + 500))
                        {
                            state = (137 << 0)
                            vsp = 10
                        }
                        break
                    case obj_knighttrap:
                        if (cooldown == 0 && state != (82 << 0) && obj_player1.x > (x - 200) && obj_player1.x < (x + 200) && obj_player1.y > (y - 100) && obj_player1.y < (y + 100))
                        {
                            state = (82 << 0)
