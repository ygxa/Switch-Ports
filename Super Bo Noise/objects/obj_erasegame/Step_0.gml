...
if (optionselected == 1 && (input_check_pressed("jump") || keyboard_check_pressed(vk_enter)))
{
...
if (input_check_pressed("slap") || keyboard_check_pressed(vk_escape) || (optionselected == 0 && (input_check_pressed("jump") || keyboard_check_pressed(vk_enter))))
{
    obj_mainmenuselect.selected = 0;
    instance_destroy();
}
