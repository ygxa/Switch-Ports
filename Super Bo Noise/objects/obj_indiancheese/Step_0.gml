...
if (elite && ragecooldown > 0)
    ragecooldown--
if (state == (136 << 0) && sprite_index == walkspr && sprite_index != spr_indiancheese_scared && elite && ragecooldown == 0)
{
