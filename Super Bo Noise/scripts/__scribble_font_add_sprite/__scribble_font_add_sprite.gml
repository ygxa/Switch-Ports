...
function __scribble_font_add_sprite_common(argument0, argument1, argument2, argument3)
{
    ...
    repeat (_size)
    {
        ...
        if (_unicode == 32)
        {
            ...
            ds_grid_set(_font_glyph_data_grid, _i, 0, _glyph);
            ds_grid_set(_font_glyph_data_grid, _i, 1, _unicode);
            ds_grid_set(_font_glyph_data_grid, _i, 2, 0);
            ds_grid_set(_font_glyph_data_grid, _i, 3, -_sprite_x_offset);
            ds_grid_set(_font_glyph_data_grid, _i, 4, -_sprite_y_offset);
            ds_grid_set(_font_glyph_data_grid, _i, 5, _space_width);
            ds_grid_set(_font_glyph_data_grid, _i, 6, _sprite_height);
            ds_grid_set(_font_glyph_data_grid, _i, 7, _sprite_height);
            ds_grid_set(_font_glyph_data_grid, _i, 8, _space_width);
            ds_grid_set(_font_glyph_data_grid, _i, 9, 0);
            ds_grid_set(_font_glyph_data_grid, _i, 10, 1);
            ds_grid_set(_font_glyph_data_grid, _i, 11, _sprite_frames[0].texture);
            ds_grid_set(_font_glyph_data_grid, _i, 12, 0);
            ds_grid_set(_font_glyph_data_grid, _i, 14, 0);
            ds_grid_set(_font_glyph_data_grid, _i, 13, 0);
            ds_grid_set(_font_glyph_data_grid, _i, 15, 0);
            ds_grid_set(_font_glyph_data_grid, _i, 16, undefined);
            ds_grid_set(_font_glyph_data_grid, _i, 17, undefined);
            ds_grid_set(_font_glyph_data_grid, _i, 18, undefined);
        ...
        else
        {
            ...
            ds_grid_set(_font_glyph_data_grid, _i, 3, _x_offset - _sprite_x_offset);
            ds_grid_set(_font_glyph_data_grid, _i, 4, _image_info.y_offset - _sprite_y_offset);
            ds_grid_set(_font_glyph_data_grid, _i, 5, _w);
            ds_grid_set(_font_glyph_data_grid, _i, 6, _h);
            ds_grid_set(_font_glyph_data_grid, _i, 7, _sprite_height);
            ds_grid_set(_font_glyph_data_grid, _i, 8, _glyph_separation);
            ds_grid_set(_font_glyph_data_grid, _i, 9, -_x_offset);
            ds_grid_set(_font_glyph_data_grid, _i, 10, 1);
            ds_grid_set(_font_glyph_data_grid, _i, 11, _texture);
            ds_grid_set(_font_glyph_data_grid, _i, 12, _uvs[0]);
            ds_grid_set(_font_glyph_data_grid, _i, 14, _uvs[1]);
            ds_grid_set(_font_glyph_data_grid, _i, 13, _uvs[2]);
            ds_grid_set(_font_glyph_data_grid, _i, 15, _uvs[3]);
            ds_grid_set(_font_glyph_data_grid, _i, 16, undefined);
            ds_grid_set(_font_glyph_data_grid, _i, 17, undefined);
            ds_grid_set(_font_glyph_data_grid, _i, 18, undefined);
            ds_map_set(_font_glyphs_map, _unicode, _i);
