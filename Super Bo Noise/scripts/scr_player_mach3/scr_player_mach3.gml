function state_player_mach3()
{
    ...
    if ((!grounded || slopeCheck(x + xscale, y)) && place_meeting_collision(x + xscale, y, 1) && !place_meeting(x + xscale, y, obj_destructibles) && !place_meeting(x + xscale, y, obj_metalblock))
    {
        wallspeed = movespeed;
    ...
    else if (place_meeting_collision(x + xscale, y, 1) && !place_meeting(x + xscale, y, obj_destructibles) && !place_meeting(x + xscale, y, obj_metalblock) && !place_meeting(x + xscale, y, obj_mach3solid))
    {
