function layer_type_get_id(argument0, argument1) //layer_type_get_id
{
...
function layer_asset_get_id(argument0) //layer_asset_get_id
{
...
function layer_get_all_sprites(argument0) //layer_get_all_sprites
{
    var temp_array = []
    if layer_exists(argument0)
    {
