function __scribble_class_element(argument0, argument1) constructor
{
    ...
    static sdf_shadow = function(argument0, argument1, argument2, argument3, argument4 = 0.25)
    {
        __sdf_shadow_colour = argument0;
        __sdf_shadow_alpha = argument1;
        __sdf_shadow_xoffset = argument2;
        __sdf_shadow_yoffset = argument3;
        __sdf_shadow_softness = max(0, argument4);
        return self;
    };
    
    static sdf_border = function(argument0, argument1)
    {
        __sdf_border_colour = argument0;
        __sdf_border_thickness = argument1;
        return self;
    };
    
    static msdf_shadow = function(argument0, argument1, argument2, argument3, argument4 = 0.25)
    {
    ...
    static __set_standard_uniforms = function(argument0, argument1)
    {
        ...
        else if (__tw_reveal != undefined)
        {
            ...
            shader_set_uniform_i(_u_iTypewriterMethod, 1);
        ...
        {
            shader_set_uniform_i(_u_iTypewriterMethod, 0);
        }
        ...
        shader_set_uniform_f(_u_vBorderColour, colour_get_red(__sdf_border_colour) / 255, colour_get_green(__sdf_border_colour) / 255, colour_get_blue(__sdf_border_colour) / 255);
