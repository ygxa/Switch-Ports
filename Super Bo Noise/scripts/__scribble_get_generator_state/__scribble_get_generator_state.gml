...
function __scribble_class_generator_state() constructor
{
    ...
    __glyph_grid = ds_grid_create(1000, 23);
    __control_grid = ds_grid_create(1000, 2);
    __word_grid = ds_grid_create(1000, 6);
    __line_grid = ds_grid_create(1000, 8);
    __stretch_grid = ds_grid_create(1000, 3);
    __temp_grid = ds_grid_create(1000, 6);
    __temp2_grid = ds_grid_create(1000, 23);
    __vbuff_pos_grid = ds_grid_create(1000, 4);
    __Reset();
}
