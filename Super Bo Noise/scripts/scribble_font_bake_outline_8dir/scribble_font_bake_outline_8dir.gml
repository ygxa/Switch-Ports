function scribble_font_bake_outline_8dir(argument0, argument1, argument2, argument3, argument4 = undefined)
{
    ...
    shader_reset();
    scribble_font_bake_shader(argument0, argument1, __shd_scribble_bake_outline_8dir, 2, 1, 1, 1, 1, 1, argument3, argument4);
}
