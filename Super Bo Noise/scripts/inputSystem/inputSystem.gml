...
function scr_setinput_init()
{
    ...
    global.deadzones[0] = ini_read_real("Option", "deadzoneMaster", 0.3);
    global.deadzones[1] = ini_read_real("Option", "deadzoneVertical", 0.5);
    global.deadzones[2] = ini_read_real("Option", "deadzoneHorizontal", 0.5);
    global.deadzones[3] = ini_read_real("Option", "deadzonePress", 0.5);
    global.deadzones[4] = ini_read_real("Option", "deadzoneSJump", 0.8);
    global.deadzones[5] = ini_read_real("Option", "deadzoneCrouch", 0.65);
    ini_close();
}
