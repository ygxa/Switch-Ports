...
function pepperman_decide_attack_phase5()
{
    ...
    else
    {
        ...
        groundpound_fakeout = 1;
        readjusting = 0;
        state = (irandom(100) > 50) ? choose(130, 130, 85) : 94;
...
function pepperman_decide_attack_phase1()
{
    ...
    else
    {
        ...
        state = (irandom(100) > chance_shoulder) ? 155 : 94;
...
function boss_pepperman_normal()
{
    ...
    if (phase > 1 && distance_to_pos(x, y, targetplayer.x, targetplayer.y, 160, global.resolutions[0][1][1]))
        attack_cooldown = 0;
...
function boss_pepperman_shoulderbash()
{
    ...
    if (shoulderbash_fakeout && !shoulderpound_fakeout && grounded && distance_to_pos(x, y, targetplayer.x, targetplayer.y, 180, global.resolutions[0][1][1]))
    {
        vsp = -11;
