function defaultParallax(argument0, argument1) //defaultParallax
{
    x += (camera_get_view_x(view_camera[0]) * argument0)
    y += (camera_get_view_y(view_camera[0]) * argument1)
}

function defaultParallaxZigZag(argument0, argument1, argument2, argument3) //defaultParallaxZigZag
{
    x += (camera_get_view_x(view_camera[0]) * argument0)
    y += (camera_get_view_y(view_camera[0]) * argument1)
...
function defaultParallaxGround(argument0, argument1) //defaultParallaxGround
{
...
function defaultParallaxH(argument0, argument1) //defaultParallaxH
{
    var bg_sprite = layer_background_get_sprite(layer_background_get_id_fixed(id))
    var bg_sprite_height = (sprite_exists(bg_sprite) ? sprite_get_height(bg_sprite) : 0)
    x += (camera_get_view_x(view_camera[0]) * argument0)
...
function defaultParallaxV(argument0, argument1) //defaultParallaxV
{
    var bg_sprite = layer_background_get_sprite(layer_background_get_id_fixed(id))
...
function defaultParallaxFar(argument0, argument1) //defaultParallaxFar
{
    var bg_sprite = layer_background_get_sprite(layer_background_get_id_fixed(id))
    var bg_sprite_width = (sprite_exists(bg_sprite) ? sprite_get_width(bg_sprite) : 0)
    var bg_sprite_height = (sprite_exists(bg_sprite) ? sprite_get_height(bg_sprite) : 0)
