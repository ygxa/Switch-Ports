function scribble_font_bake_shader(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10 = 2048)
{
    ...
    repeat (_glyph_count)
    {
        _texture = ds_grid_get(_src_glyph_grid, _i, 11);
        var _width = ds_grid_get(_src_glyph_grid, _i, 5);
        var _height = ds_grid_get(_src_glyph_grid, _i, 6);
        var _u0 = ds_grid_get(_src_glyph_grid, _i, 12);
        var _v0 = ds_grid_get(_src_glyph_grid, _i, 14);
        var _u1 = ds_grid_get(_src_glyph_grid, _i, 13);
        var _v1 = ds_grid_get(_src_glyph_grid, _i, 15);
        ...
        else
        {
            ...
            vertex_color(_vbuff, c_white, 1);
            vertex_texcoord(_vbuff, _u0, _v1);
            ds_grid_set(_new_glyphs_grid, _i, 12, _line_x);
            ds_grid_set(_new_glyphs_grid, _i, 14, _line_y);
            ds_grid_set(_new_glyphs_grid, _i, 13, _line_x + _width + argument4 + argument6);
            ds_grid_set(_new_glyphs_grid, _i, 15, _line_y + _height + argument5 + argument7);
            _line_x += _width_ext;
    ...
    ds_grid_add_region(_new_glyphs_grid, 0, 3, _glyph_count - 1, 3, -argument4);
    ds_grid_add_region(_new_glyphs_grid, 0, 4, _glyph_count - 1, 4, -argument5);
    ds_grid_add_region(_new_glyphs_grid, 0, 5, _glyph_count - 1, 5, argument4 + argument6);
    ds_grid_add_region(_new_glyphs_grid, 0, 6, _glyph_count - 1, 6, argument5 + argument7);
    ds_grid_add_region(_new_glyphs_grid, 0, 7, _glyph_count - 1, 7, argument5 + argument7);
    ds_grid_add_region(_new_glyphs_grid, 0, 8, _glyph_count - 1, 8, argument8);
    ds_grid_set_region(_new_glyphs_grid, 0, 11, _glyph_count - 1, 11, sprite_get_texture(_sprite, 0));
    ds_grid_set_region(_new_glyphs_grid, 0, 18, _glyph_count - 1, 18, argument9);
    ...
    ds_grid_multiply_region(_new_glyphs_grid, 0, 12, _glyph_count - 1, 15, 1 / argument10);
    ds_grid_multiply_region(_new_glyphs_grid, 0, 12, _glyph_count - 1, 13, _sprite_u1 - _sprite_u0);
    ds_grid_multiply_region(_new_glyphs_grid, 0, 14, _glyph_count - 1, 15, _sprite_v1 - _sprite_v0);
    ds_grid_add_region(_new_glyphs_grid, 0, 12, _glyph_count - 1, 13, _sprite_u0);
    ds_grid_add_region(_new_glyphs_grid, 0, 14, _glyph_count - 1, 15, _sprite_v0);
}
