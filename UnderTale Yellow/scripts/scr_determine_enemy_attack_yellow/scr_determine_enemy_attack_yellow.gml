function scr_determine_enemy_attack_yellow()
{
    ...
    else if (battle_enemy_name == "guardener")
    {
        ...
        switch (global.turns_passed)
        {
            ...
            case 9:
                global.enemy_attack = "Guardener Attack " + __string(irandom_range(1, 9));
                break;
            ...
            case 11:
                global.enemy_attack = "Guardener Attack " + __string(choose(irandom_range(1, 5), irandom_range(7, 8)));
                break;
