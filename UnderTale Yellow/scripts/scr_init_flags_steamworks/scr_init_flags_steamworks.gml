function scr_init_flags_steamworks()
{
    ...
    global.factory_code = __string(irandom_range(1, 9)) + __string(irandom_range(1, 9)) + __string(irandom_range(1, 9)) + __string(irandom_range(1, 9));
    global.factory_code_2 = ds_list_create();
    global.factory_code_3 = __string(irandom_range(1, 9)) + __string(irandom_range(1, 9)) + __string(irandom_range(1, 9)) + __string(irandom_range(1, 9));
