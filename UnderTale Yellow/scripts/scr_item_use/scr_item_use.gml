function scr_item_use(argument0, argument1)
{
    ...
    switch (item)
    {
        ...
        case "Wild Revolver":
            item_type = 4;
            use_msg[0] = "* (You equipped the#  " + __string(item) + ".)";
            break;
    ...
    if (item_type == 1)
    {
        ...
        if (use_msg[0] != "nothing")
        {
            ...
            with (msg)
            {
                ...
                if (heal_value > 0)
                {
                    message[msg_number] = "* Healed " + __string(heal_value) + " HP!";
                ...
                {
                    message[msg_number] = "* You gained " + __string(pp_value) + " PP!";
                ...
                {
                    message[msg_number] = "* You gained " + __string(sp_value) + " SP!";
                ...
                {
                    message[msg_number] = "* You will heal for " + __string(rp_value) + "#  turns!";
