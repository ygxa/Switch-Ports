...
{
    var action_1_selected_count, action_2_selected_count;
    
    action_1_selected_count = global.action_1_selected_count_2;
    action_2_selected_count = global.action_2_selected_count_2;
