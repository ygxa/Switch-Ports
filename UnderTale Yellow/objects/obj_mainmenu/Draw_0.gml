...
with (other)
{
    ...
    if (room == rm_mainmenu)
    {
        ...
        draw_text_outline(__view_get(e__VW.XView, 0) + 145, yy - 50, string_hash_to_newline("LV" + __string(ini_read_real("Save1", "LV", 1))));
        play_time = ini_read_real("Playtime", "Seconds", 0);
        string_minutes = __string(play_time div 60);
        string_seconds = __string(play_time % 60);
