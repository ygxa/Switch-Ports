...
if (!global.dialogue_open)
{
    ...
    draw_text(80, 330, string_hash_to_newline(__string("{0} - Select/Place#{1} - Cancel selection#{2} - Rotate/Scale item", global.action_key, global.pause_key, global.cancel_key)));
    butt1_xx = 500;
    butt1_yy = 320;
...
draw_text(320, 280, string_hash_to_newline(__string(robot_item_number) + " / " + __string(item_number_max)));
