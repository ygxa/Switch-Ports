...
for (i = 0; i < 3; i++)
    warning = instance_create_depth(x, battle_box.bbox_bottom - 4 - (i * sprite_get_height(spr_ceroba_attack_fire_pillar_warning) * 2), -100, obj_ceroba_pillar_warning_special);
