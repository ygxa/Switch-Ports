...
if (global.current_hp_self < 10 && global.current_hp_self > -10)
    draw_text_colour((314 + obj_battle_hp_max_self.sprite_width) - 25, 400, string_hash_to_newline("0" + __string(global.current_hp_self) + " / " + __string(global.max_hp_self)), text_col, text_col, text_col, text_col, global.image_alpha_enemy_attacking * image_alpha);
else
