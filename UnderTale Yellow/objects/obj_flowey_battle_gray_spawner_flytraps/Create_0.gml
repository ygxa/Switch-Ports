...
for (i = 0; i < array_length(spawn_point_x); i++)
...
{
    cur_val = ds_list_find_value(coordinate_list, i);
    warning = instance_create_depth(spawn_point_x[cur_val], spawn_point_y[cur_val], -100, obj_flowey_battle_gray_fly_trap_warning);
