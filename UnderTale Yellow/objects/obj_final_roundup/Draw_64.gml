...
draw_text(40, 150, string_hash_to_newline("TOTAL DEATHS:   " + __string(global.death_count_total)));
dalv_killed = "No";
...
draw_text(40, 260, string_hash_to_newline("ENEMIES KILLED:   " + __string(enemies_killed)));
mo_items = 0;
...
draw_text(40, 300, string_hash_to_newline("MO ITEMS BOUGHT:   " + __string(mo_items)));
slurpy_saved = "NO";

if (global.snowdin_flag[3] == 2)
    slurpy_saved = "YES";

draw_text(40, 320, string_hash_to_newline("SLURPY SAVED:   " + __string(slurpy_saved)));
draw_set_alpha(1);
micro_froggit = "NO";
...
draw_text(40, 340, string_hash_to_newline("MICRO FROGGIT FOUND:   " + __string(slurpy_saved)));
draw_set_alpha(1);
