...
leaf2 = instance_create_depth(281, 126, depth - 1, obj_flowey_battle_phase_2_lowpoly_leaf);
leaf2.sprite_index = spr_battle_flowey_lowpoly_leaf_2;
instance_create_depth(-60, 60, -100, obj_flowey_battle_phase_2_side_vine);
vine2 = instance_create_depth(700, 60, -100, obj_flowey_battle_phase_2_side_vine);
