var enemy_dead, enemy_spared, image_yscale_store, time_elapsed_head, time_elapsed_body, time_elapsed_hand_left, time_elapsed_hand_right;
...
if (!(instance_exists(obj_text_damage_count) && global.fight_number == 1) && enemy_dead == false && enemy_spared == false)
{
    ...
    time_elapsed_body = time_elapsed - time_elapsed_decrease_body;
