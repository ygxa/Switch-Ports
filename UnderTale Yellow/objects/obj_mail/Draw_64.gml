var paper_color, mail_height, stamp_yy, stamp_xx, heart_y;

paper_color = make_colour_rgb(255, 255, 245);
...
mail_height = string_height_ext(string_hash_to_newline(mail_text), 18, -1);
stamp_yy = (text_draw_y + mail_height) - 12;
stamp_xx = 210;
...
heart_y = 20 + (200 * (1 - ((text_draw_y - text_draw_min) / (text_draw_max - text_draw_min))));
