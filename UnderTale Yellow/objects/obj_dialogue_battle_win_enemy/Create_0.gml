...
switch (global.enemy_count)
{
    ...
    case 2:
        ...
        message[0] = "* YOU WON!#* You earned " + __string(global.enemy_exp + global.enemy_exp_2) + " XP and " + __string(global.enemy_gold + global.enemy_gold_2) + " gold.";
        break;
    ...
    case 3:
        ...
        message[0] = "* YOU WON!#* You earned " + __string(global.enemy_exp + global.enemy_exp_2 + global.enemy_exp_3) + " XP and " + __string(global.enemy_gold + global.enemy_gold_2 + global.enemy_gold_3) + " gold.";
        break;
