...
for (i = 0; i < bullet_number_max; i++)
{
    ...
    {
        bullet = instance_create_depth(obj_heart_battle_fighting_red.x, obj_heart_battle_fighting_red.y - 80, -100, obj_battle_enemy_attack_ceroba_flower_circle_flower);
