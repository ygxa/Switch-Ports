var random_number, attack_instance;

if (live_call())
    return global.live_result;

random_number = irandom_range(0, ds_list_size(spawner_list) - 1);
attack_instance = ds_list_find_value(spawner_list, random_number);
