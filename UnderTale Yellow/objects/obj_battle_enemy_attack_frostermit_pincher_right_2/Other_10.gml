...
state = obj_battle_enemy_attack_frostermit_pincher_right_1.state;
...
else if (state == "retract")
{
    ...
    base_angle_r = obj_battle_enemy_attack_frostermit_pincher_right_1.image_angle_r;
    base_angle_r_location = obj_battle_enemy_attack_frostermit_pincher_right_1.image_angle_r_location;
