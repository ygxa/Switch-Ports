...
for (i = 1; i < array_length_1d(global.item_slot); i += 1)
{
    ...
    item_name = __string(global.item_slot[i]);
    ...
    draw_text(obj_talk_screen_shop.x + 30 + ((i > 4) * 160), obj_talk_screen_shop.y + 10 + ((i - 1 - ((i > 4) * 4)) * 20), string_hash_to_newline(item_name + " - " + __string(item_price) + "G"));
}
