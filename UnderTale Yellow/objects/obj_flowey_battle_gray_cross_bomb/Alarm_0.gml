...
if (warning_number < 0)
{
    ...
    expl1 = instance_create_depth(x, y, -100, obj_flowey_battle_gray_cross_bomb_explosion);
    expl2 = instance_create_depth(x, y, -100, obj_flowey_battle_gray_cross_bomb_explosion);
