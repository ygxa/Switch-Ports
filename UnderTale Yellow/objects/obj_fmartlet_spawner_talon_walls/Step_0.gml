var battle_box, j, i, feather, attack_instance, inc;
...
switch (attack_tick)
{
    ...
    case 85:
        feather = instance_create_depth(battle_box.bbox_left + 25, battle_box.bbox_top - 20, -100, obj_fmartlet_feather_straight);
