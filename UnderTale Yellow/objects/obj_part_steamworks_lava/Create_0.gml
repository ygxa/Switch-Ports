...
part_life = (room_height + 100) / 0.8;
part_dist = (room_width * room_height) / 29257.14;
...
part_type_color3(global.pt_Lava_Particles, 16751615, c_white, 16770808);
