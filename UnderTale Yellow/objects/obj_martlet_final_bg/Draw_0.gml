var offset_x, offset_y, rect_size_x, rect_size_y, i;
...
offset_x = (max_size_x - (grid_size_x - bg_grid_offset)) / 2;
offset_y = (max_size_y - (grid_size_y - bg_grid_offset)) / 2;
rect_size_x = (grid_size_x - bg_grid_offset) / grid_n_x;
rect_size_y = (grid_size_y - bg_grid_offset) / grid_n_y;
