...
{
    layer_set_visible("roof_foreground", false);
    layer_set_visible("roof_base", false);
    layer_set_visible("roof_foreground_destroyed", true);
    layer_set_visible("roof_base_destroyed", true);
    instance_destroy();
    exit;
}
