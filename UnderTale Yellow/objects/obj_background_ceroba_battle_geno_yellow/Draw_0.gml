var color_rect_1, color_rect_2, color_rect_3, color_rect_4, i, diamond_x_left, diamond_x_right, vertical_line_2_x;

color_rect_1 = make_colour_rgb(73, 24, 31);
color_rect_2 = make_colour_rgb(157, 23, 50);
color_rect_3 = make_colour_rgb(216, 31, 68);
color_rect_4 = make_colour_rgb(228, 69, 101);
...
for (i = 0; i < 2; i++)
{
    diamond_x_left = diamond_x[i] - diamond_width - (diamond_width_current / 3);
    diamond_x_right = diamond_x[i] + diamond_width + (diamond_width_current / 3);
    ...
    draw_primitive_end();
    draw_primitive_begin(pr_linestrip);
    vertical_line_2_x = diamond_x[i] + diamond_width_current;
    draw_vertex(diamond_x[i], diamond_y - (diamond_height / 2));
