...
if (global.debug_toggle == true)
    draw_text(__view_get(e__VW.XView, 0) + 10, __view_get(e__VW.YView, 0) + 10, string_hash_to_newline("DEBUG MODE:#TOGGLE: 0: ON#FPS: " + __string(fps) + "#FPS REAL: " + __string(fps_real)));
else
