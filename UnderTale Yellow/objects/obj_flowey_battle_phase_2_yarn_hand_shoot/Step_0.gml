var needle_count, spawn_dir_current, i, needle;
...
switch (scene)
{
    ...
    case 2:
        ...
        {
            needle = instance_create_depth(x + random_range(-15, 15), y + random_range(-15, 15), -100, obj_flowey_battle_phase_2_yarn_needle);
