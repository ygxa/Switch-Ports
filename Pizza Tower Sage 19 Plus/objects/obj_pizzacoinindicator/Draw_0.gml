...
__draw_text_colour_hook(roundlower(obj_player.x), roundlower(obj_player.y) - 50, _string(obj_player.combopointstogive), 16777215, 16777215, 16777215, 16777215, obj_player.textalpha);
