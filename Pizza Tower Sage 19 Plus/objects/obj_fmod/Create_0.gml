...
//show_debug_message("fmod_studio_system_create: " + _string(fmod_last_result()));
fmod_studio_system_init(_max_channels, _flags_studio, _flags_core);
//show_debug_message("fmod_studio_system_init: " + _string(fmod_last_result()));
...
z = 0;
//show_debug_message(_string("Listener Status: {0}; Position: {1}, {2}, {3}", listener_setPosition(0, x, y, z), x, y, z));
