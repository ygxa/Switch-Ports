function __input_class_gamepad_motion(argument0) constructor
{
        ...
        switch (os_type)
        {
            ...
            case os_linux:
                ...
                if (is_numeric(_steam_handle))
                {
                    ...
                    if (__global.__gamepads[__index].__simple_type == "switch" || __global.__gamepads[__index].__simple_type == "xbox 360" || __global.__gamepads[__index].__simple_type == "ps4")
                        _gyro_scale *= 2;
