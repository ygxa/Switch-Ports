function __input_class_cursor() constructor
{
    ...
    static __set = function(argument0, argument1, argument2)
    {
        if (argument2)
        {
            __x += argument0;
    ...
    static __translate = function(argument0, argument1, argument2, argument3)
    {
        ...
        if (argument3)
        {
            __translation_end_x = (__translation_start_x == undefined) ? undefined : (__translation_start_x + argument0);
            __translation_end_y = (__translation_start_y == undefined) ? undefined : (__translation_start_y + argument1);
        }
        else
        {
            __translation_end_x = argument0;
            __translation_end_y = argument1;
        }
        
        __translation_active = true;
        __translation_start_time = __input_get_time();
        __translation_end_time = __translation_start_time + argument2;
    };
