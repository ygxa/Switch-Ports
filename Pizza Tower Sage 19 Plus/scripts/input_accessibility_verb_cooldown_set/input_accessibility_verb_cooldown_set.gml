function input_accessibility_verb_cooldown_set(argument0, argument1)
{
    ...
    if (is_array(argument0))
    {
        ...
        {
            input_accessibility_verb_cooldown_set(argument0[_i], argument1);
            _i++;
        }
    ...
    if (argument1)
        variable_struct_set(_global.__cooldown_dict, argument0, true);
    else
        variable_struct_remove(_global.__cooldown_dict, argument0);
}
