function fmod_path_bundle(argument0)
{
    if (os_type == os_switch)
        return _string("rom:/{0}{1}", working_directory, argument0);
    else if (os_type == os_android)
        return _string("file:///android_asset/{0}", argument0);
    else
        return _string("{0}{1}", working_directory, argument0);
}

function fmod_path_user(argument0)
{
    return _string("{0}{1}", game_save_id, argument0);
}
...
function fmod_error_string(argument0 = fmod_last_result())
{
    switch (argument0)
    {
        ...
        case (65 << 0):
            return "The retrieved _string is too long to fit in the supplied buffer and has been truncated.";
        ...
        case (77 << 0):
            return "An invalid _string was passed to this function.";
...
function fmod_debug_initialize(argument0, argument1 = (0 << 0), argument2 = pointer_null)
{
...
function fmod_dsp_add_input(argument0, argument1, argument2 = (0 << 0))
{
