function input_check(argument0, argument1 = 0, argument2 = 0)
{
    ...
    if (argument0 == -3)
        return input_check(_global.__basic_verb_array, argument1, argument2);
    ...
    if (is_array(argument0))
    {
        ...
        {
            if (input_check(argument0[_i], argument1, argument2))
                return true;
    ...
    if (argument2 <= 0)
        ...
        return _verb_struct.__held_time >= 0 && (__input_get_time() - _verb_struct.__held_time) <= argument2;
}
