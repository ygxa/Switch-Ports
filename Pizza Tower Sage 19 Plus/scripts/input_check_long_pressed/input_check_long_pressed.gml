function input_check_long_pressed(argument0, argument1 = 0, argument2 = 0)
{
    ...
    if (is_array(argument0))
    {
        ...
        {
            if (input_check_long_pressed(argument0[_i], argument1, argument2))
                return true;
    ...
    if (argument2 <= 0)
        ...
        return _verb_struct.__long_press_time >= 0 && (__input_get_time() - _verb_struct.__long_press_time) <= argument2;
}
