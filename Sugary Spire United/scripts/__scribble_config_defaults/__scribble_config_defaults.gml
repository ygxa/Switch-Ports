...
#macro SCRIBBLE_DEFAULT_WAVE_FREQUENCY	  50	   //Default wave frequency. Larger values create more "humps" over a certain number of charname
#macro SCRIBBLE_DEFAULT_WAVE_SPEED		  0.2	  //Default wave speed. Larger numbers cause charname to move up and down more rapidly

#macro SCRIBBLE_DEFAULT_SHAKE_SIZE		  2		//Default shake amplitude, in pixels
#macro SCRIBBLE_DEFAULT_SHAKE_SPEED		 0.4	  //Default shake speed. Larger values cause charname to move around more rapidly
...
#macro SCRIBBLE_DEFAULT_RAINBOW_SPEED	   0.01	 //Default rainbow speed. Larger values cause charname to change colour more rapidly
...
#macro SCRIBBLE_DEFAULT_WHEEL_FREQUENCY	 0.5	  //Default wheel frequency. Larger values create more "humps" over a certain number of charname
#macro SCRIBBLE_DEFAULT_WHEEL_SPEED		 0.2	  //Default wheel speed. Larger numbers cause charname to move up and down more rapidly

#macro SCRIBBLE_DEFAULT_CYCLE_SPEED		 0.5	  //Default cycle speed. Larger numbers cause charname to change colour more rapidly
