...
entry[i++] = [spr_beastiary_placeholder, spr_creamTHIEF_almanac, "CreamTheif", "No description set yet. (whoever made this guy... spell THIEF right.. stutid ass)", thief_kills >= 10, ["Kill 10", "Stole " + string(floor(grog_kills)) + " keys back"]];
entry[i++] = [spr_beastiary_placeholder, spr_gumslime_almanac, "Meloncool", "No description set yet.", melon_kills >= 15, ["Style on 15", string(floor(melon_kills)) + " styled on"]];
entry[i++] = [spr_beastiary_placeholder, spr_gumslime_almanac, "Popcorn", "No description set yet.", cornbig_kills >= 5, ["Butter 5", string(floor(cornbig_kills)) + " bags eaten\n" + string(floor(cornsmall_kills)) + " buttered"]];
entry[i++] = [spr_beastiary_placeholder, spr_gumslime_almanac, "Sour Buddies!!!", "No description set yet.", sour_kills >= 35, ["Kill 35", string(floor(sour_kills)) + " nuisances shaken off"]];
entry[i++] = [spr_beastiary_placeholder, spr_gumslime_almanac, "Froth", "No description set yet.", froth_kills >= 35, ["Kill 5", string(floor(froth_kills)) + " killed"]];
entry[i++] = [spr_beastiary_placeholder, spr_cherry_almanac, "Big Cherry", "No description set yet.", bigcherry_kills >= 35, ["Kill 5", string(floor(bigcherry_kills)) + " bombs detonated"]];
