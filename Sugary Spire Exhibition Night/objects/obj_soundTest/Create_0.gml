...
defineMusic("", "Exhibition Night", "Stewart Keller");
defineMusic("", "Good Morning", "Stewart Keller")
defineMusic("", "Pick Your Poison", "Stewart Keller")
defineMusic("", "Earth.", "CableChords")
defineMusic("", "Family Friendly", "PaperKitty")
defineMusic("event:/music/Soundtest/harry", "Arkoudaphobia", "Stewart Keller")
defineMusic("", "Down To Noise", "RodMod")
defineMusic("event:/music/Soundtest/entrywayPZ_secret", "there's a secret inside my breakfast?", "Various")
defineMusic("", "Steamy Cotton Candy", "RodMod", "Werecotton Mix")
...
defineMusic("", "Mineshaft Depths", "RodMod", "Minecart Mix", "RodMod, Pteracotta")
...
defineMusic("", "Lost Chocolate", "CableChords, RodMod", "Focus Mix")
...
defineMusic("", "Sugar Rush", "RodMod, CableChords, The8Bitdrummer")
defineMusic("event:/music/Soundtest/sweetrelease", "Sweet Release of Death", "RodMod")
defineMusic("", "Results!", "PaperKitty", "AWFUL Mix")
