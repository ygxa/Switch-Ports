...
musicArray = []
defineMusic("event:/music/Soundtest/intro", "Art Curse", "Paperkitty")
defineMusic("event:/music/Soundtest/title_exhibition", "Exhibition Night", "Stewart Keller")
defineMusic("event:/music/Soundtest/hub1", "Good Morning", "Stewart Keller")
defineMusic("event:/music/Soundtest/options", "Pick Your Poison", "Stewart Keller")
defineMusic("event:/music/Soundtest/pause", "Earth.", "CableChords")
defineMusic("event:/music/Soundtest/tutorial", "Family Friendly", "PaperKitty")
defineMusic("event:/music/Soundtest/harry", "Arkoudaphobia", "Stewart Keller")
defineMusic("event:/music/Soundtest/entrywayPZ", "Down To Noise", "RodMod")
defineMusic("event:/music/Soundtest/entrywayPZ_secret", "there's a secret inside my breakfast?", "Various")
defineMusic("event:/music/Soundtest/cottontownA", "Steamy Cotton Candy", "RodMod", "Werecotton Mix")
...
defineMusic("event:/music/Soundtest/minesA", "Mineshaft Depths", "RodMod", "Minecart Mix", "RodMod, Pteracotta")
...
defineMusic("event:/music/Soundtest/molassesA", "Lost Chocolate", "CableChords, RodMod", "Focus Mix")
...
defineMusic("event:/music/Soundtest/glucosegetaway", "Sugar Rush", "RodMod, CableChords, The8Bitdrummer")
