...
function ExhibitionNightSecretTask(arg0, arg1, arg2) : OutfitTask(arg0, arg1, 1, -4) constructor
{
    neededSecrets = arg2;
...
function scr_award_chef_task(arg0, arg1, arg2)
{
    ...
    if (!prevUnlocked)
        ds_queue_enqueue(obj_achievementTracker.chefUnlockQueue, [arg1, arg0, 0, arg2]);
...
function scr_task_notify(arg0, arg1 = [])
{
    ...
    with (obj_achievementTracker)
    {
        ...
        if (ind >= 0 && task.conditionType == 2 && task.taskCondition(arg1))
        {
            if (palette)
...
{
    var pals = [new ExhibitionNightSecretTask("Painter Red", 0, 3), new ExhibitionNightSecretTask("Painter Black", 0, 6), new ExhibitionNightSecretTask("Painter Purple", 0, 9), new ExhibitionNightSecretTask("Noise", 0, 12), new OutfitTask("Brainy Duds", 0, 2, function()
    {
        ini_open(global.SaveFileName);
        var judge = ini_read_string("Game", "Judgment", "none");
        fixed_ini_close();
        return judge != "none";
    }), new OutfitTask("Golden Brainy Duds", 0, 2, function()
    {
        ini_open(global.SaveFileName);
        var judge = ini_read_string("Game", "Judgment", "none");
        fixed_ini_close();
        return judge == "perfect" || judge == "holyshit";
    }), new OutfitTask("Notebook", 0, 0, function()
    {
        if (instance_exists(obj_exhibitiontrashcan))
            ...
            return false;
    }), new OutfitTask("Hazardous", 0, 0, function()
    {
        ...
        return false;
    }), new OutfitTask("Cotton Candy", 0, 0, function()
    {
...
function scr_get_chef_tasks(arg0, arg1 = true)
{
    ...
    switch (arg0)
    {
        ...
        case "mineshaft":
            ...
            tasks[2] = new ChefTask("task_sm_slug", 2, spr_bakertasks_mines, 2, function(arg0)
            {
