...
{
	if (sprite_index == spr_player_PZ_werecottonintroRight || sprite_index == spr_player_PZ_werecottonintroLeft)
    {
        hsp = 0
        vsp = 0
        movespeed = 0
        ...
        if sprite_animation_end()
        {
            ...
            xscale = targetxscale
            image_index = 0
            sprite_index = spr_player_PZ_werecottonintroscream
        }
        return;
    }
    if (sprite_index == spr_player_PZ_werecottonintroscream)
    {
        hsp = 0
        vsp = 0
        movespeed = 0
