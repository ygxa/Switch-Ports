...
scr_defineLevel(0, "secrets", "secrets of the world", secrets_intro, ["Secrets"], 16500, new scr_defineTitleCard(0, mu_titlecard_entryway, 37, 42))
...
scr_defineLevel(0, "molasses", "Molasses Swamp", molasses_1, ["Molasses", "geyserwaves"], 19000, new scr_defineTitleCard(3, mu_titlecard_swamp, 37, 498))
