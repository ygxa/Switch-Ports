...
{
    var original_prefix = argument1 + scr_getCharacterPrefix(Characters.Pizzelle);
    var full_name = sprite_get_name(argument0);
    var sprite_name = string_copy(full_name, string_length(original_prefix) + 1, string_length(full_name));
    
    var new_prefix = argument1 + scr_getCharacterPrefix(argument2);
    var asset_string = new_prefix + sprite_name;
...
function scr_characterSprite()
{
    ...
    spr_minecart = scr_getCharacterSprite(spr_player_PZ_minecart);
    spr_minecartbounce = scr_getCharacterSprite(spr_player_PZ_minecart_bounce);
    spr_minecartcrouch = scr_getCharacterSprite(spr_player_PZ_minecart_crouch);
    spr_minecartcrouchstart = scr_getCharacterSprite(spr_player_PZ_minecart_crouchstart);
    spr_minecartcrouchend = scr_getCharacterSprite(spr_player_PZ_minecart_crouchend);
    spr_minecartfall = scr_getCharacterSprite(spr_player_PZ_minecart_fall);
    spr_minecartfredBump = scr_getCharacterSprite(spr_player_PZ_minecart_fredBump);
    spr_minecartfredNervous = scr_getCharacterSprite(spr_player_PZ_minecart_fredNervous);
    spr_minecartfredScream = scr_getCharacterSprite(spr_player_PZ_minecart_fredScream);
    spr_minecartfredScreamTrans = scr_getCharacterSprite(spr_player_PZ_minecart_fredScreamTrans);
    spr_minecartgroundpound = scr_getCharacterSprite(spr_player_PZ_minecart_groundpound);
    spr_minecartgroundpoundland = scr_getCharacterSprite(spr_player_PZ_minecart_groundpoundland);
    spr_minecartgroundpoundstart = scr_getCharacterSprite(spr_player_PZ_minecart_groundpoundstart);
    spr_minecartjump = scr_getCharacterSprite(spr_player_PZ_minecart_jump);
    spr_minecartland = scr_getCharacterSprite(spr_player_PZ_minecart_land);
    spr_minecartspinOut = scr_getCharacterSprite(spr_player_PZ_minecart_spinOut);
    spr_minecartturn = scr_getCharacterSprite(spr_player_PZ_minecart_turn);
    spr_minecartturnend = scr_getCharacterSprite(spr_player_PZ_minecart_turnend);
    spr_minecartturnidle = scr_getCharacterSprite(spr_player_PZ_minecart_turnidle);
    spr_credits = scr_getCharacterSprite(spr_player_PZ_idleAnim_credits);
    spr_creditshurt = scr_getCharacterSprite(spr_player_PZ_stun);
