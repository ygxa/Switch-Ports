...
define_player_palette(Characters.Pizzelle, "Classic Duds", 16777215, 13150344, 13150344, undefined)
define_player_palette(Characters.Pizzelle, "Exhibition Duds", 12105936, 6907567, 2631776, undefined)
define_player_palette(Characters.Pizzelle, "Painter Red", 12512, 88, 88, undefined)
define_player_palette(Characters.Pizzelle, "Painter Black", 4800062, 2629656, 2629656, undefined)
define_player_palette(Characters.Pizzelle, "Painter Purple", 11230063, 7220541, 7220541, undefined, 9437384, 4194448, 12105936)
define_player_palette(Characters.Pizzelle, "Noise", 8446200, 1607896, 1607896, undefined, 1607896, 14496, 14496)
define_player_palette(Characters.Pizzelle, "Brainy Duds", undefined, 0, 4528756, spr_demopattern_brain, 6301864, 3670136, 3670136)
define_player_palette(Characters.Pizzelle, "Golden Brainy Duds", undefined, 0, 88, spr_demopattern_brainGold, 12436, 2106960, 2106960)
define_player_palette(Characters.Pizzelle, "Notebook", undefined, 0, 16296056, spr_demopattern_paper, 16298128, 13660176, 13660176)
define_player_palette(Characters.Pizzelle, "Hazardous", undefined, 0, 37088, spr_demopattern_entryway, 3160248, 2631776, 2631776)
define_player_palette(Characters.Pizzelle, "Cotton Candy", undefined, 0, 16375551, spr_demopattern_steamy, 11042984, 15743104, 9461864)
